...
The following photos in this directory and `/public/og-image.jpg` are used under
Creative Commons licenses. Attribution and license details are reproduced below
to comply with the share-alike terms.

| File | Source | Author | License | Description page |
|---|---|---|---|---|
| `og-image.jpg` | Wikimedia Commons | Alejandro Quintanar | CC BY-SA 3.0 | https://commons.wikimedia.org/wiki/File:Basilica_of_the_National_Vow.jpg |
...
description pages above under their original licenses.

Replacement workflow: when the couple has their own photos, drop them in at the
same filenames listed in `README.md` and they will replace these.
